...
def evaluate_predictions_cfm(preds: List[List[float]],
    ...
    for i in range(num_tasks):
        ...
        acc, rec, prec, f1s, tp, fp, tn, fn = confusion_mat(valid_targets[i], valid_preds[i])
    ...
    return result_AUC, result_ACC, result_REC, result_PREC, result_F1, result_TP, result_FP, result_TN, result_FN