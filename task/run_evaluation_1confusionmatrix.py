...
def run_evaluation_cfm(args: Namespace, logger: Logger = None) -> List[float]:
    ...
    test_scores_AUC, test_scores_ACC, test_scores_REC, test_scores_PREC, test_scores_F1, test_TP, test_FP, test_TN, test_FN = evaluate_predictions_cfm(
        preds=test_preds,
        targets=test_targets,
        num_tasks=args.num_tasks,
        metric_func=metric_func,
    ...
    return test_scores_AUC, test_scores_ACC, test_scores_REC, test_scores_PREC, test_scores_F1, test_TP, test_FP, test_TN, test_FN
